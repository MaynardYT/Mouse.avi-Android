...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'street': //Week 1 - Unhappy
				var bg:BGSprite = new BGSprite('street1', -600, -200, 0.9, 0.9);
				add(bg);

			case 'street': //Week 1 - Happy
				var bg:BGSprite = new BGSprite('street2', -600, -200, 0.9, 0.9);
				add(bg);

			case 'street': //Week 1 - Really Happy
				var bg:BGSprite = new BGSprite('street3', -600, -200, 0.9, 0.9);
				add(bg);
